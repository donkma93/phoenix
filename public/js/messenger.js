...
var UserItem = Vue.component("user-item", {
  props: {
    user: Object,
    selectedId: Number
  },
  data: function data() {
    ...
    var avatar = (_this$user = this.user) !== null && _this$user !== void 0 && _this$user.chat_box.user.profile.avatar ? "/".concat(this.user.chat_box.user.profile.avatar) : "/images/default.jpg";
    return {
      avatar: avatar
    };
  },
  ...
  methods: {
    choseChatBox: function choseChatBox(id) {
      console.log(id);
      this.$emit("select", id);
    }
  },
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _this.getChatDetail(true);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.prev = 2;
                _context2.next = 5;
                return axios.get("/staff/messenger/get", {
                  params: {
                    email: _this2.search
                  }
                });
              ...
              case 5:
                ...
                if (showLoading && _this2.users.length) {
                  _this2.choseChatBox(_this2.users[0].chat_box.id);
                }
              ...
              case 11:
                ...
                document.getElementsByClassName("new-message").forEach(function (el) {
                  return el.remove();
                });
...
var ChatInput = Vue.component("chat-input", {
  props: {
    chatBoxId: Number,
    disabled: Boolean
  },
  ...
  methods: {
    ...
    sendMessage: function sendMessage() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee5() {
        var message, id, nodeItem;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.prev = 0;
                message = _this5.message, id = _this5.id;

                _this5.$emit("pushMessage", {
                  id: id,
                  message: message
                });

                _this5.message = "";
                _this5.id = _this5.id - 1;
                _context5.next = 7;
                return axios.post("/staff/messenger/send", {
                  chat_box_id: _this5.chatBoxId,
                  message: message
                });

              case 7:
                nodeItem = document.querySelector("li[dataid='chat".concat(id, "'] > div"));
...
var ChatItem = Vue.component("chat-item", {
  ...
  computed: {
    dataId: function dataId() {
      return "chat".concat(this.data.id);
    }
  },
...
var ChatList = Vue.component("chat-list", {
  ...
  watch: {
    ...
    messageList: function messageList(val, oldVal) {
      if (!oldVal.length || val.length > oldVal.length) {
        this.messageListRender = _toConsumableArray(val);
      } else {
        this.messageListRender = _toConsumableArray(oldVal);
      }
    }
  },
  methods: {
    getMessage: function getMessage() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee7() {
        var needLoading, response;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                needLoading = _arguments2.length > 0 && _arguments2[0] !== undefined ? _arguments2[0] : false;
              ...
              case 3:
                ...
                _context7.prev = 4;
                _context7.next = 7;
                return axios.post("/staff/messenger/detail", {
                  chat_box_id: _this7.chatBoxId
                });

              case 7:
                response = _context7.sent;
                _this7.isLoading = false;
                _this7.messageList = response.data.listChat;
                _this7.user = response.data.chatBox.user;
                _this7.avatar = _this7.user.profile.avatar ? "/".concat(_this7.user.profile.avatar) : "/images/default.jpg";

                if (needLoading) {
                  _this7.$refs.content.scrollTop = _this7.$refs.content.scrollHeight;
                }
    ...
    pushMessage: function pushMessage(_ref2) {
      var id = _ref2.id,
          message = _ref2.message;
      this.messageList = [].concat(_toConsumableArray(this.messageList), [{
        id: id,
        message: message,
        chat_box: {
          user_id: id
...
Vue.directive("click-outside", {
  bind: function bind(el, binding, vnode) {
    el.clickOutsideEvent = function (event) {
      if (event.target.contains(document.querySelector("#btn-close-user-list")) || event.target.contains(document.querySelector("#btn-close-user-list i"))) {
        return;
      }
...
var app = new Vue({
  ...
  methods: {
    ...
    hideUserList: function hideUserList() {
    ...
    closeUserList: function closeUserList() {
      this.isShowUserList = false;
    }
  },
