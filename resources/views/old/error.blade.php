@php
    $is404 = true; // TODO: use variable instead
    $title = $is404 ? 'Page not found!' : 'Something went wrong!';
    $text = $is404 ? 'Looks like the page you were looking for is no longer here.' : $title . '<br />Please contact so we can support you in advance.'
@endphp
    ...
    <div class="container">
        <div class="left-section">
            <div class="inner-content">
                <h1 class="heading">{{ $is404 ? '404' : '500'}}</h1>
                <p class="subheading">
                    {!! $text !!}
                </p>
            </div>
