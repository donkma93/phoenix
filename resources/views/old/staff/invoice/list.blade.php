...
<div class="fade-in">
    <div class="card">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('staff.invoice.list') }}" class="form-horizontal" role="form">
                        ...
                        <tbody>
                            @foreach ($invoices as $invoice)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-info btn-block" href="{{ route('staff.invoice.detail', ['id' => $invoice->id]) }}">
                                            {{ __('Detail') }}
                                        </a>
                                    </td>
                                </tr>
