...
<div class="fade-in">
    <div class="card">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('staff.product.list') }}" class="form-horizontal" role="form">
        ...
        <div class="card-footer">
            ...
            @else
                <div class="table-responsive">
                    <table class="table table-align-middle table-bordered table-striped table-sm" id="staff-product-list-table">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>{{ __('Name') }}</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info" href="{{ route('staff.product.detail', ['id' => $product->id]) }}">Detail</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
