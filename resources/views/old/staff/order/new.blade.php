...
@section('content')
    <div class="fade-in">
        <div class="card">
            ...
            <div class="card-body">
                <div>
                    <form method="POST" action="{{ route('staff.orders.storeCSV') }}" enctype="multipart/form-data">
                        @csrf

                        <div>
                            <div class="d-flex justify-content-between align-items-center amb-12 border-bottom apb-4">
                                <h3 class="amb-4">{{ __('Create Via CSV') }}</h3>
                            </div>
            ...
            <div class="card-body">
                <div>
                    <form method="POST" action="{{ route('staff.orders.create') }}" class="form-horizontal" role="form">
                        @csrf
                        ...
                        <div class="search-form-group">
                            ...
                            <div class="search-input text-center text-sm-left">
                                <input class="btn btn-primary" type="submit" value="{{ __('Create Order') }}">
                            </div>
                        </div>
                    </form>
                </div>
