...
@section('breadcrumb')
    ...
    'items' => [
        ...
        [
            'text' => 'Request list',
            'url' => route('staff.request.list',  ['status' => $userRequest->status])
        ],
        [
            'text' => $userRequest->id
        ]
            ...
            @if(!in_array($userRequest['mRequestType']['name'], ["add package", "removal", "return"]))
                ...
                @elseif($userRequest['mRequestType']['name'] == 'warehouse labor')
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <label class="col-form-label search-label"><input type="radio" name="select-option" class="amr-16 aml-8" value="change-detail" checked/><b>{{ __('Change detail') }}</b></label>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group search-form-group">
                                    <label class="col-form-label search-label"><b>{{ __('Package unit') }}</b></label>
                                    <div class="search-input">
                                ...
                                <div class="form-group search-form-group">
                                    <label class="col-form-label search-label"><b>{{ __('Received unit') }}</b></label>
                                    <div class="search-input">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <label class="col-form-label search-label"><input type="radio" name="select-option" class="amr-16 aml-8" value="delete-package" /><b>{{ __('Delete package') }}</b></label>
                            </div>
                        </div>
                ...
                @else
                    <div class="modal-body">
                        ...
                        <div class="form-group search-form-group">
                            <label class="col-form-label search-label"><input type="checkbox" class="amr-16 aml-8" id="change-warehouse-area" /><b>{{ __('Change area') }}</b></label>
                            <div class="search-input position-relative">
                        ...
                        <div class="form-group search-form-group">
                            <label class="col-form-label search-label"><input type="checkbox" class="amr-16 aml-8"  id="change-status" /><b>{{ __('Change status') }}</b></label>
                            <div class="search-input">
...
@section('scripts')
  ...
  <script>
    ...
    if(!requestUnit.includes(requestType) && requestType != 'outbound' && requestType != 'warehouse labor') {
        filterInput(document.getElementById("shift-modal-group-to-area"), warehouses, 'dropdown-modal-area');
        $('#group-table').hide()
    }

    if(requestUnit.includes(requestType)) {
        filterInput(document.getElementById("shift-warehouse"), warehouses, 'dropdown-modal-area');
        $('#shift-table').hide()
    }
    ...
    for(let i = 0; i < warehouseInputUpdates.length; i++) {
        filterInput(warehouseInputUpdates[i], warehouses);
    }
    // End autocomplete
