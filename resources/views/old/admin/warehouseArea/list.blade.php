...
<div class="fade-in">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a class="btn btn-success" href="{{ route('admin.warehouseArea.new') }}">
                {{ __('New Area') }}
            </a>
        </div>

        <form method="GET" action="{{ route('admin.warehouseArea.list') }}" class="form-horizontal" role="form">
            <div class="card-body">
                <div class="form-group search-form-group">
                    <label for="name" class="col-form-label search-label"><b>{{ __('Name') }}</b></label>
                    <div class="search-input position-relative">
                        <input type="input" id="area-name" list="dropdown-area" class="form-control w-100" name="name" value="@if (isset($oldInput['name'])){{$oldInput['name']}}@endif" />
                ...
                <div class="form-group search-form-group">
                    ...
                    <div class="search-input position-relative">
                        <input type="input" id="warehouse-input" list="dropdown-warehouse" class="form-control w-100" id="warehouse-input" name="warehouse" value="@if (isset($oldInput['warehouse'])){{$oldInput['warehouse']}}@endif" autocomplete="off" />
                    </div>
                </div>
        ...
        <div class="card-footer">
            ...
            @else
                <div class="table-responsive">
                    <table class="table table-align-middle table-bordered table-striped table-sm" id="admin-wa-list-table">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>{{ __('Name') }}</th>
                        ...
                        <tbody>
                            @foreach($warehouseAreas as $area)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-info btn-block" href="{{ route('admin.warehouseArea.detail', ['id' => $area['id']]) }}">{{ __('Detail') }}</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
