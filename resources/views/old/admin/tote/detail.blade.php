...
<div class="fade-in">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <form action="{{ route('admin.tote.delete') }}" id="delete-tote-form" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{ $tote['id'] }}">
        ...
        <div class="card-body">
            <form action="{{ route('admin.tote.update') }}" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer btn-delete-tote">
...
<script>
    ...
    function callModal(isDelete = 0) {
        const element = $(".btn-delete-tote");
        $(".btn-ok").remove();
        let btn = "<button class='btn btn-danger btn-ok' onclick='deleteTote()'>Delete</button>"
        $(".modal-body").text('Are you sure to delete this tote?')

        if(isDelete == 1) {
            $(".modal-body").text('Are you sure to restore this tote?')
            btn = "<button class='btn btn-primary btn-ok' onclick='deleteTote()'>Restore</button>"
        }
