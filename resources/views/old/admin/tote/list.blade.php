...
<div class="fade-in">
    ...
    <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a class="btn btn-success" href="{{ route('admin.tote.new') }}">
                {{ __('New Tote') }}
            </a>
        </div>

        <div class="card-body">
            <form method="GET" action="{{ route('admin.tote.list') }}" class="form-horizontal" role="form">
        ...
        <div class="card-footer">
            ...
            @else
                <div class="table-responsive">
                    <table class="table table-align-middle table-bordered table-striped table-sm" id="admin-tote-list-table">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>{{ __('Name') }}</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(isset($tote->deleted_at))
                                        {{ __('Deleted') }}
                                    @else
                                        {{ App\Models\Tote::$statusName[$tote->status] }}
                                    @endif
                                </td>
                                <td>
                                    <a class="btn btn-info" href="{{ route('admin.tote.detail', ['id' => $tote->id]) }}">Detail</a>
                                </td>
