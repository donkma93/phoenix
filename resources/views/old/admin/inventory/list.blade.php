...
<div class="fade-in">
    <div class="card">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('admin.inventory.list') }}" class="form-horizontal" role="form">
        ...
        <div class="card-footer">
            ...
            @else
                <div class="table-responsive">
                    <table class="table table-align-middle table-bordered table-striped table-sm" id="admin-inventory-list-table">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>{{ __('Product') }}</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info" href="{{ route('admin.inventory.detail', ['id' => $inventory->id]) }}">Detail</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
