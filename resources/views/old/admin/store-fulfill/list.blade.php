...
<div class="fade-in">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a class="btn btn-success" href="{{ route('admin.storeFulfill.new') }}">
                {{ __('New Store Fulfill') }}
            </a>
        </div>
        <div class="card-body">
            <form method="GET" action="{{ route('admin.storeFulfill.list') }}" class="form-horizontal" role="form">
        ...
        <div class="card-footer">
            ...
            @else
                <div class="table-responsive">
                    <table class="table table-align-middle table-bordered table-striped table-sm" id="admin-store-list-table">
                        <thead>
                            <tr>
                                <th>{{ __('No') }}</th>
                                <th>{{ __('Name') }}</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info" href="{{ route('admin.storeFulfill.detail', ['id' => $store->id]) }}">Detail</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
