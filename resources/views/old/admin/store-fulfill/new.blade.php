...
@section('content')
<div class="fade-in">
    <form action="{{ route('admin.storeFulfill.create') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header">
                <h2 class="mb-0">{{ __('Create Store') }}</h2>
            </div>
            <div class="card-body">
                ...
                <div class="search-form-group">
                    ...
                    <div class="search-input text-center text-sm-left">
                        <input class="btn btn-primary" type="submit" value="{{ __('Create Store') }}">
                    </div>
                </div>
            </div>
        </div>
