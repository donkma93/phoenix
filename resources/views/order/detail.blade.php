...
<div class="content">
    ...
    <div class="card px-4 py-2">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            @if(!in_array($order->status, [App\Models\Order::STATUS_DONE, App\Models\Order::STATUS_CANCEL]) && $order->picking_status != 5)
                <div>
                    <div class="btn btn-round btn-danger" onclick="updateStatus({{ $order->id }}, 3)">
                        {{ __('Cancel Order') }}
                    </div>
                    <div class="btn btn-round btn-success" onclick="updateStatus({{ $order->id }}, {{ $order->status }})">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('staff.orders.updateOrder') }}" enctype="multipart/form-data">
                ...
                <div>
                    @if($order->status === App\Models\Order::STATUS_INPROGRESS)
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                <input type="submit" class="btn btn-round btn-success" value="Update">
                            </div>
                        </div>
                    @else
                        <div class="row">
            ...
            @foreach ($order->orderProducts as $index => $orderProduct)
                <div class="ap-24">
                    <div class="d-flex mt-2 amx-n16 amb-8">
            ...
            <div class="ap-24">
                @if($order->status !== App\Models\Order::STATUS_INPROGRESS)
                    <div class="d-flex align-items-center mt-2 amx-n16 amb-8">
                        <div class="rq-pkg-field min-w-80 apx-16">
                            <b>{{ __('Length:') }}</b>
                        </div>
                ...
                @else
                    ...
                    @csrf
                        ...
                        <div class="d-flex mt-2">
                            <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                <input type="submit" class="btn btn-round btn-success" value="Update package">
                            </div>
                        </div>
                    </form>
                @endif
