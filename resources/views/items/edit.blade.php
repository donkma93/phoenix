                            ...
                            <form method="post" class="item-form" action="{{ route('item.update', $item) }}" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="name" id="input-name" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Name') }}" value="{{ old('name', $item->name) }}" required autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('photo') ? ' has-danger' : '' }} d-flex flex-column">
                                        ...
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail ">
                                                <img src="{{ $item->picture ? $item->path() : asset('/img/image_placeholder.jpg') }}" alt="...">
                                            </div>
                                            ...
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label" for="input-picture">{{ $item->picture }}</label>
                                            </div>
