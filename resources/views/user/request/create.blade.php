            ...
            <div class="card-body">
                <form method="POST" action="{{ route('requests.store') }}" class="form-horizontal" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group search-form-group">
                        <label for="m_request_type_id" class="search-label col-form-label min-w-160 text-left"><b>{{ __('Type') }}</b></label>
                    ...
                    <div class="form-group search-form-group">
                        <label for="note" class="col-form-label search-label min-w-160 text-left"><b>{{ __('Note') }}</b></label>
                        <div class="search-input">
