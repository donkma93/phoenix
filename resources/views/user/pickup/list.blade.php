                        ...
                        <table class="table table-align-middle table-bordered table-striped table-sm"
                            ...
                            <tbody>
                                @foreach ($data['pickups'] as $pickup)
                                    <tr>
                                        <td style="text-align: center;">{{ ($data['pickups']->currentPage() - 1) * $data['pickups']->perPage() + $loop->iteration }}
                                        </td>
                                        <td>
                                            {{ $pickup->pickup_code }}
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            @if($pickup->status == App\Models\PickupRequest::NEW)
                                                {{--
                                                <a class="btn btn-primary" href="{{ route('pickup.list') }}"
...
@push('scripts')
    <script>
        function deletePickup(pickup_id) {
            ...
            let is_confirm = confirm('Do you want to delete this pickup!');
            if (is_confirm) {
                document.getElementById('delete-form-'+pickup_id).submit();
            }
        }
    </script>
@endpush
...
{{-- @section('scripts')
    <script>
        ...
        */
        ...
        createSuggestBlock(document.getElementById("warehouse-input"), warehouses, 'dropdown-area');
