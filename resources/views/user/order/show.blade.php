        ...
        <div class="fade-in">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <hr
                        style="display: {{ empty($order->orderTransaction) ? 'flex' : (!$order->orderTransaction->tracking_number ? 'flex' : 'none') }}">
                    ...
                    <div class="row"
                        ...
                        <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                            <div class="form-group row">
                                <label class="col-4 col-sm-3 col-form-label"><b>{{ __('Tracking Number') }}</b></label>
                                <div class="col-8 col-sm-9 form-control border-0">
                                    <input class="form-control" name="tracking_code" placeholder="Tracking number" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                            <div class="form-group row">
                                ...
                                <div class="col-8 col-sm-9 form-control border-0">
                                    <input type="file" accept="application/pdf" hidden id="tracking_file"
                                        name="tracking_file" class="btn-primary form-control">
                    ...
                    <div class="row mb-3">
                        <div class="col-12 col-md-6 col-lg-12 col-xl-6 mb-3">
                            ...
                            <div class="form-group row mb-3">
                                <label class="col-4 col-sm-3 col-form-label"><b>{{ __('Order Files') }}</b></label>
                                <div class="col-8 col-sm-9 form-control border-0">
                                            ...
                                            <div style="margin:10px 0">
                                                ...
                                                @if (str_ends_with($info, 'pdf'))
                                                    ...
                                                    <button type="button" class="btn btn-success" data-toggle="modal"
                                                        ...
                                                        onclick="previewPDF(`{{ $info }}`)">
                                                        {{ basename($info) }}
                                                    </button>
                                                @else
                                                    {{ $loop->index + 1 }} |
                                                    <a target="_blank"
                                                        href="{{ $info }}">{{ basename($info) }}</a>
                                                @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                            <div class="form-group row">
                                <label
                                    class="col-4 col-sm-3 col-form-label"><b>{{ __('Item Compare At Price') }}</b></label>
                                <div class="col-8 col-sm-9 form-control border-0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                            <div class="form-group row">
                                <label
                                    class="col-4 col-sm-3 col-form-label"><b>{{ __('Item Requires Shipping') }}</b></label>
                                <div class="col-8 col-sm-9 form-control border-0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                            <div class="form-group row">
                                <label
                                    class="col-4 col-sm-3 col-form-label"><b>{{ __('Item Fulfillment Status') }}</b></label>
                                <div class="col-8 col-sm-9 form-control border-0">
                        ...
                        <div class="ap-24 px-3">
                            ...
                            <div class="row amx-n16 amb-8">
                                ...
                                <div class="col apx-16">
                                    {{ ucfirst(App\Models\Product::$statusName[$orderProduct->product->status]) }}</div>
                            </div>
                            ...
                            <div class="row amx-n16 amb-8">
                                ...
                                @else
                                    <div class="col apx-16">
                                        <img id="image-upload" width="300" height="300"
                                            src="{{ asset($orderProduct->product->image_url) }}" alt="Product image"
                                            class="img-fluid">
                                    </div>
                                @endif
                            </div>
