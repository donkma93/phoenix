        ...
        <div class="card-body">
            <form method="GET" action="{{ route('package_groups.index') }}" class="form-horizontal" role="form">
                <div class="form-group search-form-group">
                    <label for="name" class="col-form-label search-label min-w-160 text-left"><b>{{ __('Name') }}</b></label>
                ...
                <div class="form-group search-form-group">
                    <label for="barcode" class="col-form-label search-label min-w-160 text-left"><b>{{ __('Barcode') }}</b></label>
                    <div class="search-input position-relative">
                        ...
                        <button type="button" id="start-button" class="btn scan-btn apy-4" data-toggle="modal" data-target="#scan-modal"
                        style="position: absolute; top: 0; right: 0; margin: 1px;">
        ...
        <div class="card-footer">
            @if (count($packageGroups))
                ...
                <div class="d-flex justify-content-center justify-content-md-end amt-16">
                    {{ $packageGroups->appends(request()->all())->links() }}
                </div>
            @else
