...
use App\Services\Admin\AdminToteService;
use Exception;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class AdminToteController extends AdminBaseController
{
    protected $toteService;

    public function __construct(AdminToteService $toteService)
    {
        parent::__construct();
    ...
    {       
        ...
        return view('admin.tote.list', $info);
    }
    ...
    {       
        ...
        return view('admin.tote.new' , $info);
    }
    ...
    {       
        try {
            ...
            return redirect()->route('admin.tote.detail', ['id' => $id])->with('success', "Create tote successfully!");
        } catch(Exception $e) {
            Log::error($e);
    ...
    public function detail(Request $request, $id) 
    {
        ...
        return view('admin.tote.detail', $packages);
    }
    ...
    public function delete(Request $request)
    {
        try {
            $parameters = $request->all();
            $this->toteService->delete($parameters);
